                ...
                >
                  <span
                    className={cn(
                      ...
                      i % 2 === 0
                        ? `before:hidden before:md:block before:md:content-[''] before:w-2/3 before:h-[1px] before:absolute before:top-[50%] before:translate-y-[-50%] before:left-[100%] before:bg-foreground`
                        : ""
                    )}
                  >
                    {item}
