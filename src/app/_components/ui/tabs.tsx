...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "flex flex-nowrap items-center justify-center rounded-md bg-transparent p-1 text-muted-foreground",
      className
    )}
    {...props}
  />
