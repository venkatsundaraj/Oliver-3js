  ...
  return (
    ...
    >
      <div className="container mx-auto  px-4 md:px-8 lg:px-16">
        ...
        <ul className="grid grid-cols-2 md:grid-cols-2 w-full items-start gap-x-3 md:gap-x-14 gap-y-2 justify-center relative ">
          ...
          <li className="text-secondary-foreground font-heading font-normal text-[clamp(24px,2vw,38px)] leading-tight ">
